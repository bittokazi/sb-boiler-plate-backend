...
/*	clients.inMemory()
	        .withClient(constants.oauth_client_id)
	            .authorizedGrantTypes("password", "authorization_code", "refresh_token", "implicit")
	            .authorities("ROLE_CLIENT", "ROLE_TRUSTED_CLIENT")
	            .scopes("read", "write", "trust")
	            .secret(constants.oauth_client_secret)
	            .resourceIds(RESOURCE_ID)
	            .accessTokenValiditySeconds(3600*8) //Access token is only valid for 8 hours.
	            .refreshTokenValiditySeconds(Integer.MAX_VALUE); //Refresh token is valid to max time.
	            */
	}
